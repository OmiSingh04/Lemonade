...
public class WordGuess extends ListenerAdapter {
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
		...
		if (message.startsWith(App.SERVER_PREFIX + "GUESS")) {// if the player has just started the game
		...
		if (isInGame && event.getAuthor().getIdLong() == memberID && this.channel == event.getChannel()) {// the same
																											// person
																											// and the
																											// same game
